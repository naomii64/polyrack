class TextureEditor {
    static textureViewCanvas=document.getElementById('texture-canvas');
    static ctx=TextureEditor.textureViewCanvas.getContext('2d');
    static list=document.getElementById('texture-list');
